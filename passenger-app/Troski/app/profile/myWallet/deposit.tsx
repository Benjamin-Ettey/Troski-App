...
const Deposit = () => {
    ...
    const handleNext = () => {
        ...
        if (value !== number){
            setError('Use your registered number with Troski.')
            return;
        }
        ...
        <View className="flex-1 bg-general">
            <KeyboardAwareScrollView
                ...
                <View className="w-full flex-1 flex items-center px-6">
                    ...
                    <View className="w-full">
                        <Text className="text-xl tracking-tight font-GoogleSansMedium">Amount to be deposited?</Text>
                    </View>
                    ...
                    {isDisabled?
                        (<DisabledPrimaryButton name="Deposit" />)
                        :
                        (<PrimaryButton name="Deposit" disabled={isDisabled} onPress={handleNext}/>)
                    }
                </View>
            </KeyboardAwareScrollView>
            <KeyboardToolbar/>
