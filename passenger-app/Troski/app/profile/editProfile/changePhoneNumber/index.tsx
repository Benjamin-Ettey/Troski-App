    ...
    return (
        <View style={{backgroundColor: colorScheme === "dark"? "#000000" : "#F5F7FA", flex: 1}}>
            ...
            <View style={{paddingLeft: 24, paddingRight: 24 }} className="w-full flex-1 flex flex-col ">
                <Text style={{marginBottom: 16}} className="font-GoogleSansRegular text-secondaryBlack dark:text-tertiaryWhite text-center flex-shrink">Use Change Phone number to migrate your account info and settings from your current phone number to a new phone number. You can&apos;t undo this change.</Text>
