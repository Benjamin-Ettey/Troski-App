                ...
                className="flex-1">
                    ...
                    <View className="w-full flex-1 flex items-center px-6">
                        <View className="w-full mb-4">
                            <Text className="text-2xl font-GoogleSansMedium tracking-tight">Verify 6 digit pin</Text>
                            <Text className="text-sm font-GoogleSansRegular">Re-enter 6 digit pin code</Text>
