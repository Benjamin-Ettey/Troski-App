                ...
                className="flex-1">
                    ...
                    <View className="w-full flex-1 flex items-center px-6">
                        <View className="w-full py-2">
                            <Text className="text-xl font-GoogleSansMedium dark:text-general tracking-tight">What&apos;s your full name?</Text>
                        </View>
                        ...
                        <View className="mb-8 w-full items-start">
                            <Text className="text-sm font-GoogleSansRegular dark:text-tertiaryGray">This shows on your Troski profile.</Text>
                            <Text className="text-sm font-GoogleSansRegular dark:text-tertiaryGray">Your full name should be at least 3 characters.</Text>
                        ...
                        <View className="w-full mb-8">
                            <View className="flex flex-col mb-4">
                                <Text className="text-sm text-nowrap mb-1 font-GoogleSansRegular dark:text-tertiaryGray">By tapping on &quot;Create account&quot;, you agree to Troski&apos;s Terms of Use.</Text>
                            ...
                            <View className="flex flex-col">
                                <Text className="text-sm text-nowrap mb-1 font-GoogleSansRegular dark:text-tertiaryGray">By tapping on &quot;Create account&quot;, you agree to Troski&apos;s Privacy policy</Text>
