                    ...
                    <OtpModal/>: <>
                        ...
                        <View className="w-full flex-1 flex items-center px-6">
                            <View className="w-full mb-4">
                                ...
                                {via?
                                    <Text className="text-sm dark:text-tertiaryWhite font-GoogleSansRegular">Type in the 6-digit verification sent to <Text className="font-GoogleSansBold dark:text-tertiaryWhit">{number}</Text> in the
                                        field provided.</Text>
                                    :
                                    <Text className="text-sm dark:text-tertiaryWhite font-GoogleSansRegular">Type in the 6-digit verification sent to <Text className="font-GoogleSansBold dark:text-tertiaryWhit">{email}</Text> in the
                                        field provided.</Text>
                                }
                            ...
                            <View className="mt-6 mb-8 w-full flex flex-col justify-center items-start">
                                <View className="flex flex-row justify-start w-full ">
                                    <Ionicons name="lock-closed" size={10} color="gray" style={{marginRight: "2%"}}
                                              className="mt-1"/>
                                    <Text style={{flexShrink: 1}} className="text-sm mb-1 dark:text-tertiaryWhite font-GoogleSansRegular">Do not share this PIN code
                                        with anyone. </Text>
                                </View>
