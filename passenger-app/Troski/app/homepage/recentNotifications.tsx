        ...
        <View style={{backgroundColor: colorScheme === "dark"? "#000000" : "#F5F7FA", flex: 1}} className="w-full">
            ...
            {showNotifications?
                <View style={{flex: 1, marginTop: "-20%"}} className="w-full flex justify-center items-center">
                    ...
                    <Text className="font-GoogleSansMedium dark:text-general">No Recent Notifications.</Text>
                    <Text style={{marginBottom: 16}} className="font-GoogleSansRegular text-center flex-shrink dark:text-tertiaryWhite">All your recent notifications will appear here.</Text>
                                            ...
                                            <View
                                                ...
                                                <View className="w-full flex flex-row gap-2 items-center ">
                                                    <Text
                                                        ...
                                                        className=" text-secondaryBlack font-GoogleSansRegular rounded-full dark:text-tertiaryGray">{item.message}</Text>
