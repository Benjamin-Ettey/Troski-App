    ...
    return (
        <View style={{backgroundColor:  "#F5F7FA"}} className="flex-1">
            ...
            <View className="w-full h-64 flex flex-row justify-center items-center">
                <Ionicons name="phone-portrait" size={72} color="#000000"/>
                <Ionicons name="swap-horizontal-outline" size={32} color="#000000"/>
            ...
            <View className="absolute bottom-0 h-28  w-full flex justify-center items-center">
                <PrimaryButton name="Next" disabled={false} onPress={()=>router.replace("/homepage/profile/editProfile/changePhoneNumber/changeOldPhoneNumber")}/>
            </View>
