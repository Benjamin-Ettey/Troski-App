...
const ChangeOldPhoneNumber = () => {
    ...
    const validate = (text: string) => {
        ...
        if (cleaned.length === 0) {
            setError('');
        } else if (cleaned.length === 10 && cleaned !== drivernumber) {
    ...
    const handleChangePhoneNumber = () => {
        ...
        router.replace("/homepage/profile/editProfile/changePhoneNumber/otpChangePhoneNumber");
    };


    const isDisabled = value.length !== 10 || newValue.length !== 10 || value !== drivernumber || newValue === value;
            ...
            <KeyboardAwareScrollView
                ...
                <View className="w-full flex-1 flex items-center px-6">
                    <View className="w-full py-2">
                        <Text className="text-xl leading-6 tracking-tight font-GoogleSansMedium ">Enter old phone number?</Text>
                    </View>
                    ...
                    <TextInput
                        ...
                        className="h-14 mb-1 font-medium  text-secondaryGray w-full py-4 border border-tertiaryGray   rounded-xl focus:border focus:border-green-600/40"
                    ...
                    <View className="w-full py-2">
                        <Text className="text-xl leading-6  tracking-tight font-GoogleSansMedium ">Enter new phone number?</Text>
                    </View>
