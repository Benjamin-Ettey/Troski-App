        ...
        <View style={{backgroundColor: "#F5F7FA"}} className="flex-1">
            <ScrollView>
                <View className="w-full mb-6 px-5">
                    <Text
                        className="font-GoogleSansRegular text-base pl-4 leading-tight mb-1 text-secondaryBlack ">Ride Notifications</Text>
                    <View
                        style={{backgroundColor: "#ffffff"}}
                        className="flex justify-center items-center h-14 rounded-full px-5">
                        <TouchableOpacity
                            className="w-full flex flex-row justify-between items-center">
                            <Text className="font-GoogleSansMedium text-secondaryGray text-base leading-tight">Ride Update Notifications</Text>
                            <Switch
                    ...
                    <Text
                        className="text-xs leading-tight pl-4 mt-2 font-GoogleSansRegular text-secondaryGray  dark:text-tertiaryGray"
                    >Receive ride status updates and important trip notifications.</Text>
                </View>


                <View className="w-full mb-6 px-5">
                    <Text className="font-GoogleSansRegular text-base pl-4 leading-tight mb-1 text-secondaryBlack ">Payment Notifications</Text>
                    <View style={{backgroundColor: "#ffffff"}}
                          className="flex flex-row rounded-full px-5 justify-center h-14 items-center">
                        <TouchableOpacity
                            style={{ flex:1}}
                            className="w-full flex flex-row justify-between items-center">
                            <Text className="font-GoogleSansMedium text-secondaryGray text-base leading-tight">Payment Notifications</Text>
                            <Switch
                ...
                <View className="w-full mb-6 px-5">
                    <Text
                        className="font-GoogleSansRegular text-base pl-4 leading-tight mb-1 text-secondaryBlack ">Promotions & Announcements</Text>
                    <View style={{ backgroundColor: "#ffffff"}}
                        ...
                        <TouchableOpacity
                            ...
                            <Text className="font-GoogleSansMedium text-secondaryGray text-base leading-tight">Announcements</Text>
                            <Switch
                ...
                <View className="w-full mb-6 px-5">
                    <Text className="font-GoogleSansRegular text-base pl-4 leading-tight mb-1 text-secondaryBlack ">Reset Notifications</Text>
                    <View style={{backgroundColor: "#ffffff"}}
                          className="flex h-14 px-5 rounded-full justify-center items-center">
                        <TouchableOpacity
                                          onPress={handleResetNotification}
                                          className="w-full flex-1 flex flex-row justify-between items-center">
                            <Text style={{color: "#ff0000"}} className="font-GoogleSansMedium text-base leading-tight">Reset all notifications</Text>
                    ...
                    <Text
                        style={{ color: "#ff0000"}}
                        className="text-xs leading-tight pl-4 mt-2 font-GoogleSansRegular"
