...
export const useAppStore = create((set)=> ({
    ...
    setNewVehicleType: (newvehicletype) => set({ newvehicletype }),
    setNewVehicleNumberPlate: (newvehiclenumberplate) => set({ newvehiclenumberplate }),
    setNewVehicleColor: (newvehiclecolor) => set({ newvehiclecolor }),
    setNewVehicleCapacity: (newvehiclecapacity) => set({ newvehiclecapacity }),
    setNewVehiclePhoto: (newvehiclephoto) => set({ newvehiclephoto }),
