    ...
    return (
        <View style={{backgroundColor: colorScheme === "dark"? "#000000" : "#F5F7FA"}} className="flex-1">
            <ScrollView className="py-2">
                ...
                <View className="w-full mb-6 px-5">
                    <Text
                        className="font-GoogleSansRegular text-base pl-4 leading-5 mb-1 text-secondaryBlack dark:text-general">Display</Text>
                    <View
                        style={{backgroundColor: colorScheme === "dark"? "#0a0a0a":"#ffffff"}}
                        className="flex justify-center items-center h-14 rounded-full px-5">
                        <TouchableOpacity style={{ flex:1}} onPress={()=>setShowTheme(true)} className="w-full flex flex-row justify-between items-center">
                            <Text className="font-GoogleSansMedium text-base leading-5 text-secondaryGray  dark:text-general">Appearance</Text>
                            <Ionicons name="color-palette-outline" size={18} color="gray"/>
                        </TouchableOpacity>
                    </View>
                    <Text
                        className="text-xs leading-4 pl-4 mt-2 font-GoogleSansRegular text-secondaryGray  dark:text-tertiaryGray"
