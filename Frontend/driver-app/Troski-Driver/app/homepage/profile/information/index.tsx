        ...
        <View style={{backgroundColor: "#F5F7FA"}} className="flex-1">
            <ScrollView contentContainerStyle={{paddingBottom: 100}}>
                ...
                <View className="w-full px-6 mb-2 flex flex-col justify-start">
                    <Text  className="font-GoogleSansMedium text-base leading-tight text-secondaryBlack">Information</Text>
                    <Text  className="font-GoogleSansRegular text-sm leading-tight text-secondaryBlack">Learn more about Troski and how it works.</Text>
                </View>

                <View className="w-full px-5  flex flex-col justify-center items-center">
                    <View
                          className="w-full p-5">
                        <Text className="font-GoogleSansRegular text-base leading-tight mb-3 flex-shrink text-secondaryBlack">
                        ...
                        <Text className="font-GoogleSansRegular text-base leading-tight flex-shrink text-secondaryBlack">
                ...
                <View className="w-full px-6 mt-5 flex flex-col justify-start">
                    <Text  className="font-GoogleSansMedium text-base leading-tight text-secondaryBlack">How Troski Driver Works</Text>
                </View>
                    ...
                    <View
                        ...
                        <TouchableOpacity
                            ...
                            <View className="w-full flex flex-row justify-between items-center">
                                <Text className="font-GoogleSansMedium text-base leading-tight text-secondaryBlack">Help Center</Text>
                                <Ionicons name="chevron-forward" size={16} color="gray"/>
                            </View>

                            <Text className="text-xs leading-tight font-GoogleSansRegular text-secondaryBlack">Get Help, Call us.</Text>
                        ...
                        <TouchableOpacity
                            ...
                            <View className="w-full flex flex-row justify-between items-center">
                                <Text className="font-GoogleSansMedium text-base leading-tight text-secondaryBlack">Send Feedback</Text>
                                <Ionicons name="chevron-forward" size={16} color="gray"/>
                            </View>

                            <Text className="text-xs leading-tight font-GoogleSansRegular text-secondaryBlack">Report technical issues.</Text>
                ...
                <View  className="w-full px-12  flex flex-col justify-start ">
                    <Text className="font-GoogleSansMedium  text-secondaryBlack text-base leading-tight">Troski&copy;</Text>
                </View>
            </ScrollView>
        </View>
    )
