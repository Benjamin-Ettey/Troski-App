  ...
  return (
    <div className="flex flex-col gap-24 pb-24">
      ...
      <section className="max-w-3xl mx-auto px-8 pt-12 text-center flex flex-col gap-4 items-center">
        <h1 className="text-5xl font-bold">About Troski</h1>
      ...
      {/* Starting Point */}
      <section className="w-full flex justify-center">
        <div className="w-[90%] md:w-[70%] flex flex-col gap-4 items-start">
          <h2 className="text-3xl font-bold">Starting at KNUST</h2>
      ...
      {/* Values */}
      <section className="w-full flex justify-center">
        <div className="w-[90%] md:w-[70%] grid grid-cols-1 md:grid-cols-3 gap-8">
