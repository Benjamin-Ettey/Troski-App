...
const HowItWorks = () => {
  useSEO({
    title: "How It Works | Troski",
    description:
      "See how Troski works — from downloading the app to getting matched with a verified driver.",
  });
  ...
  return (
    <div className="flex flex-col gap-12 md:gap-16 pb-24">
      <section className="max-w-3xl mx-auto px-6 md:px-8 pt-12 text-center flex flex-col gap-4 items-center">
        <h1 className="text-4xl md:text-5xl font-bold">How Troski Works</h1>
        ...
        <div className="w-[90%] md:w-[70%] grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
          {steps.map((step, index) => (
            <div key={step.title} className="flex flex-col gap-2">
              <span className="text-[#ffcc00] font-bold text-xl md:text-2xl">
